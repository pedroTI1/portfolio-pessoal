...
const Projetos = props => (
    <main id="projetos" className="Projetos">
        ...
        <Projeto title="Calculadora"
            ...
            image={Calc}
            link="https://github.com/ppedroalves/projetoCalculadora" />
        <Projeto title="LP Agência Bold"
            ...
            image={Page}
            link="https://github.com/ppedroalves/paginaHTML" />
        <Projeto title="Bank Account"
            ...
            image={Java} 
            link = "https://github.com/ppedroalves/emprestimo"/>
        <div className="btn-portfolio">
            <a href="https://github.com/ppedroalves" target="_blank" rel="noreferrer">Confira mais projetos aqui!</a>
        </div>
